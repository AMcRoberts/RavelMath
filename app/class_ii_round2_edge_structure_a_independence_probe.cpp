...
// whether the forward-edge GRAPH STRUCTURE among the 195 raw states
...
int main() {
    ...
    std::printf(
        "%s\n",
        edges_all_same
            ? "ROUND2_EDGE_STRUCTURE_IS_A_INDEPENDENT: the entire "
              "forward-edge connectivity graph over the 195 raw "
