...
/-- Mechanically emitted: instantiates the general lemma above for
    letters 0 and 2 on a 5-letter alphabet (3 collision steps). -/
theorem first_letter_orbit_instance_0 :
    hasCoincidencePrefix
      (applyN (![[0, 1], [2], [3], [4], [0]] : Fin 5 → List (Fin 5)) 3 [(0 : Fin 5)])
      (applyN (![[0, 1], [2], [3], [4], [0]] : Fin 5 → List (Fin 5)) 3 [(2 : Fin 5)]) :=
  first_letter_orbit_collision_forces_coincidence (![[0, 1], [2], [3], [4], [0]] : Fin 5 → List (Fin 5)) (by decide)
    (0 : Fin 5) (2 : Fin 5) 3 (by decide)

/-- Mechanically emitted: instantiates the general lemma above for
    letters 1 and 3 on a 5-letter alphabet (4 collision steps). -/
theorem first_letter_orbit_instance_1 :
    hasCoincidencePrefix
      (applyN (![[0, 1], [2], [3], [4], [0]] : Fin 5 → List (Fin 5)) 4 [(1 : Fin 5)])
      (applyN (![[0, 1], [2], [3], [4], [0]] : Fin 5 → List (Fin 5)) 4 [(3 : Fin 5)]) :=
  first_letter_orbit_collision_forces_coincidence (![[0, 1], [2], [3], [4], [0]] : Fin 5 → List (Fin 5)) (by decide)
    (1 : Fin 5) (3 : Fin 5) 4 (by decide)

/- Semantic proof graph for: first_letter_orbit_batch
  [0] lean.first_letter_orbit_certificate :: d=5 i=0 j=2 k=3 letters 0 and 2 on a 5-letter alphabet -- instantiates first_letter_orbit_collision_forces_coincidence
  [1] lean.first_letter_orbit_certificate :: d=5 i=1 j=3 k=4 letters 1 and 3 on a 5-letter alphabet -- instantiates first_letter_orbit_collision_forces_coincidence
-/
