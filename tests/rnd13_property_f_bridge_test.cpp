...
int main() {
    ...
    const std::array<std::vector<std::int8_t>, d> images{
        std::vector<std::int8_t>{0, 0, 1, 2, 3, 3},
        std::vector<std::int8_t>{0, 0, 2, 3, 3},
        std::vector<std::int8_t>{0, 0, 3, 3},
        std::vector<std::int8_t>{0, 0, 0, 2, 3, 3}};
    ...
    limits.closure_cap = 60'000;
    limits.corona_cap = 300'000;
