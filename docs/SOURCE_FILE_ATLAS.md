...
| `include/ravel/proof/finite_graph_correspondence.hpp` | Finite-to-one graph correspondences plus iterative escape-boundary and symbolic height certificates for live relations reaching terminal states. |
